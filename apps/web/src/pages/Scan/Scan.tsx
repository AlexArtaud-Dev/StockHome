...
export function ScanPage() {
  ...
  async function handleQrCode(scanned: string) {
    try {
      // QR codes generated by this app store the full container URL.
      // Try to parse the URL and extract the container ID directly.
      try {
      ...
      // Legacy / external QR codes: look up by the qrCode UUID field
